...
You'll see the name "zag" in task file paths, CLI owner names, and configuration. Argos was built for daily use with an AI assistant named [Zag](https://en.wikipedia.org/wiki/Zagreus) (an OpenClaw agent). Where you see "zag," think "agent" or "automation" — it's the owner bucket for tasks the AI handles.
...
See [docs/task-format.md](docs/task-format.md) for the full task format specification.
...
| `vaultPaths.zag` | Path to agent/automation tasks | `/data/obnotes/zag/zag-tasks.md` |
...
Full format docs: [docs/task-format.md](docs/task-format.md)
